      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <p className="about__text">
            Metro Electric Services &amp; Consulting is the trusted source for residential,
            commercial, and industrial electrical work across Palm Beach, Broward, and Miami-Dade.
            We are the exclusive electrical contractor for many of the region&apos;s top general
            contractors and developers.
          </p>
          <p className="about__text">
            From panel upgrades and smart home automation to industrial control panels and generator
            hookups, we bring professional-grade workmanship, permit handling, and transparent pricing
            to every job — residential or commercial.
          </p>

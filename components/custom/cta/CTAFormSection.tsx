...
export default function CTAFormSection() {
  ...
  const WHY_LEFT = [
    ...
    "Fast response — we invest in technology to stay ready",
    "Serving South Florida since 2003",
  ];
  const WHY_RIGHT = [
    "Exclusive contractor for top South Florida GCs",
    "Bilingual service — English & Spanish",
    "Panels, smart home, generators, industrial work",
    "Reliable, transparent pricing on every job",
  ];
    ...
    <section className="cta-form" ref={sectionRef}>
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          <div className="cta-form__eyebrow hidden md:block">Get It Done Right</div>
          <h2 className="cta-form__heading hidden md:block">
            We&apos;re ready to help <br />with any electrical project
          </h2>
          <h2 className="cta-form__heading block md:hidden">
            Get in touch
          </h2>
          <p className="cta-form__subtext hidden md:block">
            Residential, commercial &amp; industrial electrical work across South Florida
            <br />— licensed, insured, and permit-ready.
          </p>
        ...
        <div className="cta-form__right">
          ...
          <h2 className="cta-form__heading">Trusted Across South Florida</h2>
          <p className="cta-form__text">
            Since 2003, Metro Electric has been the electrical contractor of choice for homeowners,
            property managers, and South Florida&apos;s top general contractors and developers.
            We care — and it shows in our work.
          </p>
          <p className="cta-form__text">
            Whether you need a panel upgrade at your home, a full electrical build-out for a
            commercial project, or an industrial installation — we bring the right team, the right
            equipment, and the permits to match.
          </p>

    ...
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          <Link href="/">
            <Image
              src="/Metro-electric-logo-darkbg.png"
          ...
          <p className="footer__desc">
            <strong>Metro Electric Services &amp; Consulting</strong> is a licensed electrical contractor
            serving Palm Beach, Broward, and Miami-Dade since 2003. Residential, commercial, and industrial
            electrical work — done right, done to code. Se habla español.
          </p>
          <div className="footer__socials">
            <a href="https://www.facebook.com/Metro-Electric-Service-2313802875525383/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social-link">
            ...
            <a href="https://www.instagram.com/metroelectricservice/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer__social-link">
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 Metro Electric Services &amp; Consulting. All rights reserved.</p>

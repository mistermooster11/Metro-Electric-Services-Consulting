      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Our Electrical Services in South Florida
          </h2>
          <p className="faq__subtext">
            Find clear answers about our residential, commercial, and industrial electrical services,
            permitting, service area, and what to expect from Metro Electric.
          </p>

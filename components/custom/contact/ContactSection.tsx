          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                1750 Osceola Drive, Suite #4<br />West Palm Beach,&nbsp;Florida&nbsp;33409
              </p>
              ...
              <div className="contact-section__social">
                ...
                <Link href="https://www.facebook.com/Metro-Electric-Service-2313802875525383/" className="contact-social-icon" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                ...
                <Link href="https://www.instagram.com/metroelectricservice/" className="contact-social-icon" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                  <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:+15613662200">(561) 366-2200</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                {/* TODO: Replace with Metro Electric's actual email address */}
                <Link href="mailto:contact@metroelectricservices.com">contact@metroelectricservices.com</Link>
              </p>
            </div>

    ...
    <section className="become-section" ref={sectionRef}>
      <div className="become-section__inner">
        <p className="become-section__intro">
          Metro Electric is growing its team of licensed electricians across Palm Beach, Broward &amp; Miami-Dade.
          If you are a professional, reliable, and motivated electrician with 2+ years of experience,

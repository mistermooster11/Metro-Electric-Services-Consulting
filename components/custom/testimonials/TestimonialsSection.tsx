    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">Trusted Since 2003</div>
          <h2 className="testimonials__heading">What Our Clients Say</h2>
          <p className="testimonials__subtext">
            Homeowners, property managers, and South Florida&apos;s top general contractors trust Metro
            Electric for professional electrical work — residential, commercial, and industrial — done right.
          </p>
        </div>
